...
const STEPS = [
  { label: 'Problem', port: 5173 },
  { label: 'Solution', port: 5173 },
  { label: 'Profe', port: 5173 },
  { label: 'Consent', port: 5173 },
  { label: 'Chatbot', port: 5173 },
  { label: 'Dashboard', local: true },
];

export default function DemoBreadcrumb({ current }) {
